                ...
                <div class="row">
                  <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                    <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInUp"
                        data-caption-delay="0">{{$slider->title}}</span></h1>
                    <p class="big swiper-text" data-caption-animate="fadeInLeft" data-caption-delay="300">
                      {{$slider->description}}</p><a
                      class="button button-lg button-primary button-winona button-shadow-2" href="{{$slider->link}}"
                      data-caption-animate="fadeInUp" data-caption-delay="300">{{$slider->text_link}}</a>
                  </div>
                </div>
              </div>
            </div>
