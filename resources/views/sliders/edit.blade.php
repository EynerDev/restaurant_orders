...
<div class="row col-md-8 offset-md-2">
    <div class="card shadow">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{route('slider.index')}}" class="btn btn-primary">Volver</a>
        </div>
        <div class="card-body">

            <x-error />

            <form method="POST" action="{{route('slider.update', $slider->id)}}" class="form-row"
                ...
                <div class="col-6">
                    <img src="{{asset($slider->image)}}" width="80" alt="">
                </div>    
                <div class="col-6">
                    <div class="form-wrap">
